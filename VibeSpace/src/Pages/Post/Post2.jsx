      ...
      <div className="content flex justify-center items-center">
        <div className="post flex flex-row">
          <div className="post1 flex flex-col">
            ...
            <img src={postimg[posts[1].image]} className="imgpost2" />
          </div>

          <div className="postcontent">
            <div className="useracc flex flex-row">
              <img
                src={usericons[users[posts[1].user_id - 1].avatar]}
                className="useravatar"
              />
              <h3 className="username font-bold">
                {users[posts[1].user_id - 1].username}
              </h3>
            ...
            <div className="postcap flex flex-col">
              ...
              <p className="caption postcaption relative">{posts[1].caption}</p>
            </div>
